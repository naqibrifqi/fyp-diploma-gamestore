		...
		<div class ="wrapper">
			<div class="content-wrapper">
				<?php
					...
					if($result) {
						echo '<h1 style="font-family: Verdana;">Pre-Order Items</h1><a href="instock.php" style="float:left;">< In Stock</a><a class="selection_link" href="rental_solution.php" style="float:right;">Rental ></a><hr>';
						echo '<table align="center" cellspacing="2" cellpadding="10"><tr>';
