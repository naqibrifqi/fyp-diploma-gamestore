	...
	<body>
		...
		<div class ="wrapper">
			<?php
				...
				if($result) {
					echo '<h1 style="font-family: Verdana; text-align:Center">Rental Solutions</h1><a href="product_catalogue.php" style="float:left;">< Pre Order</a><a href="instock.php" style="float:right;">In Stock ></a><hr>';
					...
					*DELIVERY TO WHOLE PENINSULA MALAYSIA (T&C Apply)<br /><br />';
					...
					for($i=0, $max = 4; $row = mysqli_fetch_array($result, MYSQLI_ASSOC);) {
						if($i++ % $max == 0)
								echo '<tr>';
